    ...
    <Card>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Påskejakten.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Påskejakten, accessible from{" "}
            <a
              href="https://P%C3%A5skejakten.no"
              rel="external nofollow noopener"
            >
              https://Påskejakten.no
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://p%C3%A5skejakten.no/kontakt"
            rel="external nofollow noopener"
          >
            https://påskejakten.no/kontakt
          </a>
        </li>
      </ul>
    </Card>
